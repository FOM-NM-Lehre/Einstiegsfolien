...
:::
::: {.column width="45%"}
```{r cat-scale8_img, fig.align="center", out.width="85%", fig.cap="Quelle: [Etsy](https://www.etsy.com/de/listing/1032124670/emotion-check-in-emotional-regulation?ga_order=most_relevant&ga_search_type=all&ga_view_type=gallery&ga_search_query=stimmung+skala&ref=sr_gallery-1-16&sts=1)"}
