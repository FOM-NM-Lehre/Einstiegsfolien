...
Die Antworten 3 bis 4 sind sicherlich Quatsch. 
Was wir gerne wissen wollen würden ist:
$$
  Pr(Entzündung = ja \,|\, Zendil = ja)
$$

Wir wissen nun aus der Aufgabe, das 

$$
  Pr(Entzündung = ja \,|\, Zendil = ja) = 50% \cdot Pr(Entzündung = ja \,|\, Zendil = nein)
$$

Und $Pr(Entzündung = ja \,|\, Zendil = nein)$ ist gebau die Antwort 1. Nicht jedoch die Antwort 2, da es nur eine Teilmenge von $\{Zendil = nein\}$ ist.