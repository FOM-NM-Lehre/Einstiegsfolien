...
\begin{aligned}
\color{purple}{
\widehat{\text{total_bill}}_i} = `r round(coef(erg_lm)[1],2)` &`r round(coef(erg_lm)[2],2)`\cdot\begin{cases}1 &: \color{olive}{\text{i ist Lunch}} \\ 0 &: \color{olive}{\text{i ist nicht Lunch}} \end{cases} \\
